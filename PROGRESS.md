...
Open deviations:
             ...
             - fx-02 §9 V5 and V11 are NOT MET; see the resume block. The
               calibration §2.2 requires was attempted and withdrawn because it
               was fitted to single-render measurements that vary by a factor of
               four. The unit ships §2.2's own relation and the ledger says the
               rows are open rather than showing a number that came from noise.
             ...
             - fx-02 §9 V9 names "the loop signal" and the wet output is not it:
               ...
               -3.44 dBFS, which is the limiter's own threshold.
