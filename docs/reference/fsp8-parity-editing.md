...
| Zoom vertically                   | `Shift+E` / `Shift+W`                                                                                                                                                                         | zoom tool vertical drag + toolbar taller/shorter → `workspace.laneScale` (0.6–2.5, saved); still no key                         | `PARTIAL`                |
...
| Track-height key commands         | assignable                                                                                                                                                                                    | `Track.height` per track (header grip, track menu) + `workspace.laneScale` global; still no key                          | `PARTIAL`                |
