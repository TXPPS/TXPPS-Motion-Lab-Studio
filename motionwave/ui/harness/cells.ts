...
export const CELLS: readonly CellDefinition[] = [
  ...
  { id: 'D2', group: 'DSP', title: 'ranges/tapers', appliesTo: 'all', requires: [], needs: [] },
  {
    id: 'D3',
    group: 'DSP',
    title: 'sheet verification',
    appliesTo: 'all',
    requires: [],
    needs: ['renderer', 'sheet'],
  },
  {
    id: 'D4',
    group: 'DSP',
    title: 'bypass null −120',
    appliesTo: 'all',
    requires: [],
    needs: ['renderer'],
  },
  {
    id: 'D5',
    group: 'DSP',
    title: 'oversampling + alias dBc',
    appliesTo: 'all',
    requires: [],
    needs: ['renderer', 'oversampling'],
  },
  {
    id: 'D6',
    group: 'DSP',
    title: 'rates 44.1–192',
    appliesTo: 'all',
    requires: [],
    needs: ['renderer'],
  },
  ...
  },
  {
    ...
    appliesTo: 'all',
    requires: [],
    needs: ['renderer', 'tempoSync'],
  },
  {
    id: 'I13',
    group: 'Instruments',
    title: 'polyphony + stealing',
    appliesTo: 'instrument',
    requires: [],
    needs: ['renderer', 'voices'],
  },
  {
    id: 'I14',
    group: 'Instruments',
    title: 'stuck-note fuzz',
    appliesTo: 'instrument',
    requires: [],
    needs: ['voices'],
  },
